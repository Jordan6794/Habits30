	...
	return (
		<div className={styles.pageDiv}>
            ...
            <div className={styles.paragraphsDiv}>
                <p className={styles.paragraph}>Your habits are tracked in regards to their <span className="main-color">streaks,</span> which means how many days you have been sucessful without failing too much.</p>
                ...
                <p className={styles.paragraph}>However, if you keep being sucessful, your habit will progress into the next streaks until it becomes a <span className="main-color">solidified habit.</span></p>
            </div>
